                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <section style={{
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                {[
                                    { icon: 'history_edu', label: 'Transcript Requests', badge: '4' },
                                    { icon: 'school', label: 'Degree Audits', badge: null },
                                    { icon: 'description', label: 'Course Evaluations', badge: null },
                                ].map((item, i) => (
                                    <button key={i} style={{
                                        width: '100%',
                                        display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                        ...
                        <section style={{
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                <span className="material-symbols-outlined" style={{
                                    marginBottom: '0.75rem', opacity: 0.8, display: 'block',
                                ...
                                <p style={{
                                    ...
                                    Set up automated approval for students with a GPA above 3.8 in your department.
                                </p>
                                <button style={{
